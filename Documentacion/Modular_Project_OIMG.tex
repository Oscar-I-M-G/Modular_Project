...
\newcommand{\TITULOS}{\fontsize{14pt}{1.5pt}\selectfont}
\newcommand{\SUBTITULOS}{\fontsize{12pt}{1.5pt}\selectfont \bfseries}
\newcommand{\GENERAL}{\fontsize{12pt}{1.5pt}\selectfont}
\newcommand{\TITULOtABLA}{\noindent{\fontsize{10pt}{1.5pt}\selectfont \bfseries}}
...
\vspace{0.5cm}
% titulo 0
{\scshape\large\bfseries Titulo del proyecto aqui\par}
\vspace{0.5cm}
% titulo 1
{\scshape\large\bfseries Proyecto Modular de Ingenierira Electronica y Computacion\par}
\vspace{1.0cm}
% Estudiante
{\large \textbf{Presenta}\\Oscar Iván Moreno Gutiérrez \#220942754\par}
\vfill
% Profesor
{\large \textbf{Asesor@} \\Dr. Afanador Delgado Samuel Mardoqueo \par}
\vfill
\vfill
% Fecha
\begin{flushright}
  {\normalsize Lagos de Moreno, Jalisco \\ \today}
\end{flushright}
\vfill}
{\large  \par}
\end{titlepage}
